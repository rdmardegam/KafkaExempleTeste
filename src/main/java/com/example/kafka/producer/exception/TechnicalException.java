...
public class TechnicalException extends BaseException {
	 ...
	 */
	public TechnicalException(String code, String message, String instruction, String detail) {
	 ...
	 */
	public TechnicalException(String code, String message, String instruction, Throwable cause) { // NOSONAR
	...
	/**
	 * Construtor para uma <code>TechnicalException</code> com a causa da falha ou
	 * erro.
	 * 
	 * @param cause A causa da falha ou erro.
	 */
	...
	/**
	 * Construtor para uma <code>TechnicalException</code> com a mensagem e a causa
	 * da falha ou erro.
	 * 
	 * @param message Mensagem explicativa da falha ou erro.
