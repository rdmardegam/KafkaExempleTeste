...
public class BaseException extends RuntimeException {
	...
	/**
	 * Construtor para uma <code>BaseException</code> com o código de identificação
	 * 
	...
	/**
	 * Construtor para uma <code>BaseException</code> com o código de identificação,
	 * mensagem, instrução e detalhe da falha ou erro.
	 * 
	...
	/**
	 * Construtor para uma <code>BaseException</code> com a mensagem e a causa da
	 * falha ou erro.
	 * 
	 * @param message Mensagem explicativa da falha ou erro.
	 ...
	 * 
	 * @param code O código de identificação da falha ou erro para atribuir.
	 */
	 ...
	 * 
	 * @param instruction A instrução para tratamento da falha ou erro para
	 *                    atribuir.
	 */
	 ...
	 * 
	 * @param detail O detalhe da falha o erro para atribuir.
	 */
	 ...
	 * 
	 * @param errorCodes Os códigos de erro
	 */
	 ...
	 * 
	 * @param handled - true para Tratada, ou false para Não tratada
	 */
