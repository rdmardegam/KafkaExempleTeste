...
public class BusinessException extends BaseException {
	...
	/** Parâmetros a substituir na mensagem correspondente à {@link #messageKey} */
	 ...
	 */
	public BusinessException(String code, String message, String instruction, Throwable cause) { // NOSONAR
		super(code, message, instruction, "");
	}

	/**
	 * Construtor para uma <code>BusinessException</code> com a mensagem da falha ou
	 * erro.
	 * 
	 * @param message Mensagem explicativa da falha ou erro.
	 */
	...
	/**
	 * Construtor para uma <code>BusinessException</code> com a causa da falha ou
	 * erro.
	 * 
	 * @param cause A causa da falha ou erro.
	 */
	...
	/**
	 * Construtor para uma <code>BusinessException</code> com a mensagem e a causa
	 * da falha ou erro.
	 * 
	 * @param message Mensagem explicativa da falha ou erro.
	...
	/**
	 * Construtor para uma <code>BusinessException</code> com a mensagem da falha ou
	 * erro e bundle key para internacionalizacao
	 * 
	 * @param message    Mensagem explicativa da falha ou erro
	...
	/**
	 * Construtor para uma <code>BusinessException</code> com a mensagem da falha ou
	 * erro, bundle key para internacionalizacao e a causa do erro
	 * 
	 * @param message    Mensagem explicativa da falha ou erro
	 * @param messageKey Bundle key para internacionalizacao
	 * @param cause      A causa da falha ou erro
