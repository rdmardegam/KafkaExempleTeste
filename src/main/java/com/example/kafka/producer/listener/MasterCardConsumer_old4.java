...
//
//@Component
//public class MasterCardConsumer_old4 {
//
...
//	
//	
//	public MasterCardConsumer_old4(CircuitBreakerRegistry circuitBreakerRegistry) {
...
///*		LogSplunk.info(Splunk.builder().key("token.ativacao").customMessage("Iniciando ativacao token")
...
//		retryOrDLQrMsg.put("payload",  mapper.treeToValue(mapper.readTree(consumerRecord.value()).get("payload"), MasterCardDTO.class));
//		
//		Message<Map<String, Object>> record = MessageBuilder.
//	             withPayload(retryOrDLQrMsg).
//	             setHeader(KafkaHeaders.TOPIC, "MASTER_CARD_TOKEN_ACTIVATION_PRIMEIRO_RETRY").
...
//	public void messageListenerRetry(ConsumerRecord<String, String> consumerRecord, Acknowledgment ack ,  @org.springframework.messaging.handler.annotation.Header(KafkaHeaders.RECEIVED_TIMESTAMP)  long ts ) throws Exception {
//		System.out.println("\n\n");
//		System.out.println("CONSUMINDO ************** RETRY 1");
//		
//////		System.out.println("****** RETRYYYYY INIT");
...
////		System.out.println("***  ***");
////		
////		Long valueSend = consumerRecord.timestamp();
//		//Long valueSendNextExecution = getNextExecutionByHeader(consumerRecord.headers(), "dataHoraProximaTentativa");
//		
////		System.out.println("***");
////		System.out.println(valueSend);
////		System.out.println(valueSendNextExecution);
////		System.out.println("***");
//		
//		System.out.println("*****");
...
//		
//		
//		if(System.currentTimeMillis() >= ts + (1000 * 20) ) {
//			//ack.acknowledge();
//			//processMsg(consumerRecord, ack);
//			System.out.println("END RETRY 1");
//		} else {
//			System.out.println("Falta RETRY 1: " + (ts + (1000 * 20) - System.currentTimeMillis() ));
//			ack.nack(ts + (1000 * 20) - System.currentTimeMillis());
//			return;
//		}
//		
//		Map<String, Object> retryOrDLQrMsg = new HashMap<String, Object>();
...
//		Message<Map<String, Object>> record = MessageBuilder.
//	             withPayload(retryOrDLQrMsg).
//	             setHeader(KafkaHeaders.TOPIC, "MASTER_CARD_TOKEN_ACTIVATION_SEGUNDO_RETRY").
//	             setHeader(KafkaHeaders.TIMESTAMP, Instant.now().toEpochMilli()).
//	             build();
//		
//		kafkaTemplate.send(record).get();
...
//			//processMsg(consumerRecord, ack);
//			System.out.println("END RETRY 2");
//		} else {
//			System.out.println("Falta RETRY 2 : " + (ts + (1000 * 30) - System.currentTimeMillis() ));
//			ack.nack(ts + (1000 * 30) - System.currentTimeMillis());
//			return;
//		}
//		
//		ack.acknowledge();
